...
android {
    namespace = "nodomain.pacjo.wear.watchface.nothing_digital"
    compileSdk = 36

    defaultConfig {
        applicationId = "nodomain.pacjo.wear.watchface.nothing_digital"
        minSdk = 28
        targetSdk = 36
        versionCode = 10
        versionName = "1.0"

        manifestPlaceholders["watchFaceServiceClassName"] = "$applicationId.NothingDigitalWatchFaceService"
    }
