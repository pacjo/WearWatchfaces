...
android {
    namespace = "nodomain.pacjo.wear.watchface.clean_colorful"
    compileSdk = 36

    defaultConfig {
        applicationId = "nodomain.pacjo.wear.watchface.clean_colorful"
        minSdk = 26
        targetSdk = 36
        versionCode = 10
        versionName = "1.0"

        manifestPlaceholders["watchFaceServiceClassName"] = "$applicationId.CleanColorfulWatchFaceService"
    }
