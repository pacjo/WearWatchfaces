...
class AnalogRendererAdapter(
    ...
    private val handStyleFeature: HandStyleFeature? by lazy {
        features.filterIsInstance<HandStyleFeature>().firstOrNull()
    }
...
//        renderer.drawClock(canvas, bounds, zonedDateTime)     // TODO: unused in analog
        handStyleFeature?.currentHandStyle?.value?.draw(canvas, bounds, zonedDateTime)
